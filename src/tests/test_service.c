...
START_TEST(test_func_insert_1) {
  s21_decimal a = {
      {0b00000000000000000000000000100011, 0b00000000000000000000000000000000,
...
START_TEST(test_func_insert_3) {
  s21_decimal a = {
      {0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
       0b00000000000000000000000000000000, 0b00000000000000000000000000000001}};
...
START_TEST(test_func_insert_5) {
  s21_decimal a = {
      {0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
       0b00000000000000000000000000000000, 0b00000000000000000000110000000001}};
